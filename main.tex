...
\textbf{Contexto:} A pesquisa será realizada utilizando os repositórios do sistema de controle de versões Git.\\
 \textbf{Objetivo:} Identificar quais fatores sociais tem relação com a entropia e se existe impacto na qualidade do software. \\
 ...
 \textbf{Resultados esperados:} É esperado que a entropia esteja relacionada com os aspectos sociais.
% ou, para TCC 2:
% \textbf{Contexto:} \\
% \textbf{Objetivo:} \\
% \textbf{Método:} \\
